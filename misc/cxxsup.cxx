 ...
 * Last edited on October 09 of 2020, at 21:44 BRT */
 ...
 * allocations. You maybe wondering, WTF is Long UInt32? Heap::Allocate takes UIntPtr, right? Yeah, you're right,
 * but the ::new and the ::delete operators take size_t (long unsigned int), which here, using our custom defines,
 * is Long UInt32). */
