 ...
 * Last edited on August 22 of 2020, at 11:43 BRT */

#ifndef __CHICAGO_MM_HXX__
#define __CHICAGO_MM_HXX__
...
public:
	...
	static Void Initialize(UInt8*, UIntPtr, UIntPtr, UIntPtr, UIntPtr);
...
private:
	...
	static UIntPtr KernelStart, KernelEnd,
				   RegionCount, MaxAddress,
				   MaxBytes, UsedBytes;
