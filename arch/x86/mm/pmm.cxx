...
Void PmmInit(Void) {
	 ...
	 * InInit variable, that allow us to call ::InitializeRegion. */
	...
	/* Let's InitializeRegion all of the free physical memory regions (that contains usable memory),
	 * making sure to NOT InitializeRegion the kernel pages, and in the end, call ::FinishInitialization. */
	...
	/* The virtual memory manager (that is, the heap) needs to know where the kernel ends, let's also save
	 * where it starts. */
